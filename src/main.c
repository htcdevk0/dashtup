...
{
    fprintf(stream,
            C_CYAN "Usage:" C_RESET " " C_GREEN "%s" C_RESET " <command> [target]\n"
                   "\n" C_MAGENTA "Commands:" C_RESET "\n"
                   "  " C_YELLOW "install" C_RESET "           Install /bin/dash, ~/.dash stdlib and ~/.dash/doc\n"
                   "  " C_YELLOW "install bin" C_RESET "       Install only /bin/dash\n"
                   "  " C_YELLOW "install std" C_RESET "       Install only the Dash stdlib into ~/.dash\n"
                   "  " C_YELLOW "install doc" C_RESET "       Install only the Dash docs into ~/.dash/doc\n"
                   "  " C_RED "uninstall" C_RESET "         Remove Dash and restore a backup binary if one exists\n"
                   "  " C_BLUE "version" C_RESET "           Show dashtup, Dash and docs versions\n"
                   "  " C_BLUE "license" C_RESET "           Show dashtup license information\n"
                   "  " C_CYAN "help" C_RESET "              Show this help message\n"
                   "\n" C_MAGENTA "Examples:" C_RESET "\n"
                   "  " C_GREEN "%s install" C_RESET "\n"
                   "  " C_GREEN "%s install bin" C_RESET "\n"
                   "  " C_GREEN "%s install std" C_RESET "\n"
                   "  " C_GREEN "%s install doc" C_RESET "\n"
                   "  " C_GREEN "sudo %s install" C_RESET "\n",
